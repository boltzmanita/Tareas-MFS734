...
//=========  (Fri Jun 23 17:35:43 2023) by ROOT version 6.28/02
   TCanvas *c1_n2 = new TCanvas("c1_n2", "c1_n2",52,64,700,500);
   ...
   TPaveText *pt = new TPaveText(0.4090544,0.9344958,0.5909456,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
